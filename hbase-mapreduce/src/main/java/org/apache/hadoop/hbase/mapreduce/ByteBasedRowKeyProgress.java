...
/**
 * {@link RowKeyProgress} implementation that treats row keys as raw byte sequences.
 * Converts the leading bytes to a big-endian unsigned numeric value and computes progress as a
 * linear fraction of the key space.
 */
