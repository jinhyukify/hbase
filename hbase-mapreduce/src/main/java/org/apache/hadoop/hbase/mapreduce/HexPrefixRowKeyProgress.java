 ...
 *
 * <pre>
 * conf.setClass("hbase.mapreduce.rowkey.progress.class",
 *   HexPrefixRowKeyProgress.class, RowKeyProgress.class);
...
public class HexPrefixRowKeyProgress extends Configured implements RowKeyProgress {
  public static final String PREFIX_LENGTH_KEY = "hbase.mapreduce.rowkey.progress.hex.prefix.length";
