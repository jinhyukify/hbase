...
public class TestHexPrefixRowKeyProgress {
  ...
  private static RowKeyProgress createWithPrefixLength(byte[] start, byte[] stop, int prefixLength) {
  ...
  public void testMidpoint() {
    assertEquals(0.5f,
      create(Bytes.toBytes("0000"), Bytes.toBytes("ffff")).getProgress(Bytes.toBytes("8000")), 0.01f);
  }

  @Test
  public void testQuarterPoint() {
    assertEquals(0.25f,
      create(Bytes.toBytes("0000"), Bytes.toBytes("ffff")).getProgress(Bytes.toBytes("4000")), 0.01f);
  }
