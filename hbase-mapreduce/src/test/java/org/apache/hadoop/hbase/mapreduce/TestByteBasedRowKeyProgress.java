...
public class TestByteBasedRowKeyProgress {
  ...
  public void testMidpoint() {
    assertEquals(0.5f,
      create(new byte[] { 0x00 }, new byte[] { (byte) 0xFF }).getProgress(new byte[] { (byte) 0x80 }), 0.01f);
  }
  ...
  public void testNearMid() {
    assertEquals(0.48f,
      create(Bytes.toBytes("aaa"), Bytes.toBytes("zzz")).getProgress(Bytes.toBytes("mmm")),
      0.01f);
  }
  ...
  public void testNearEnd() {
    assertEquals(1.0f,
      create(Bytes.toBytes("aaa"), Bytes.toBytes("zzz")).getProgress(Bytes.toBytes("zzy")),
      0.01f);
  }
